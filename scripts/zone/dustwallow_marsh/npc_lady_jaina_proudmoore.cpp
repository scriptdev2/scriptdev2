...
/* ScriptData
SDName: NPC_Lady_Jaina_Proudmoore
SD%Complete: 100
SDComment: For quest 558
EndScriptData */
...
bool GossipHello_npc_lady_jaina_proudmoore(Player *player, Creature *_Creature)
{
    ...
    {
        player->ADD_GOSSIP_ITEM( 0, "Give me autograph.", GOSSIP_SENDER_MAIN, GOSSIP_SENDER_INFO );
...
void AddSC_npc_lady_jaina_proudmoore()
{
    Script *newscript;
