...
#define    SPELL_REFLECT    23920 //Not Implantened (Heroic mod)
...
#define SAY_DIE               "My death means ... little."
#define SOUND_DIE             10447
...
struct MANGOS_DLL_DECL boss_temporusAI : public ScriptedAI
{
    ...
    uint32 Haste_Timer;
    uint32 Spell_Reflection_Timer;
    bool InCombat;

    void EnterEvadeMode()
    { 
        Haste_Timer = 20000;
        Spell_Reflection_Timer = 40000;
        InCombat = false;

        //Immune to taunt
        //m_creature->ApplySpellImmune(TAUNT, IMMUNITY_SPELLID, IMMUNE_SCHOOL_MAGIC, true);
