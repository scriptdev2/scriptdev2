...
{
    LumberjackAI(Creature *c) : ScriptedAI(c) {EnterEvadeMode();}
    ...
    void EnterEvadeMode()
    {
        ...
        //update to start chopping when loaded, and this will also make it if anyone of them reset they will chop after going home
    }
